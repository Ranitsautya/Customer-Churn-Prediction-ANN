...
```bash
git clone https://github.com/Ranitsautya/customer-churn-ann.git
...
Ranit Sautya
B.Tech UndeGraduate | Python | SQL | AI & ML Enthusiast
...
CONNECT WITH ME :
Email : ranitsautya@gmail.com
🔗LinkedIn : [Ranit Sautya](https://www.linkedin.com/in/ranitsautya)
